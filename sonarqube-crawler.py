...
if __name__ == '__main__':
  ...
  list_component = getData("https://sonarqube.x.com.vn/api/components/search?qualifiers=TRK", token)
  list_metricKeys = getData("https://sonarqube.x.com.vn/api/metrics/search", token)
